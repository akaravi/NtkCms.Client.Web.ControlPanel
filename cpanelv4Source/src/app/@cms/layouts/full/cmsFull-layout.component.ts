...
@Component({
  ...
  templateUrl: './cmsFull-layout.component.html',
  styleUrls: ['./cmsFull-layout.component.scss']
})
export class CmsFullLayoutComponent implements OnInit, AfterViewInit, OnDestroy {
