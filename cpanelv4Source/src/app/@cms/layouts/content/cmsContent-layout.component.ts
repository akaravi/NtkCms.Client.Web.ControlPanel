...
@Component({
  ...
  templateUrl: './cmsContent-layout.component.html',
  styleUrls: ['./cmsContent-layout.component.scss']
})
export class CmsContentLayoutComponent implements OnInit, AfterViewInit, OnDestroy {
