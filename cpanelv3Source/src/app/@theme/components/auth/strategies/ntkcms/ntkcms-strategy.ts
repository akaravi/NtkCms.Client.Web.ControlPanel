 ...
 * (which is inside of the `NbNtkcmsAuthStrategy` class), so you have to replace it with a custom helper function
 * if you need it.
 *
 * ```ts
 ...
 */
@Injectable()
export class NbNtkcmsAuthStrategy extends NbAuthStrategy {
  protected defaultOptions: NbNtkcmsAuthStrategyOptions = ntkcmsStrategyOptions;

  static setup(
    options: NbNtkcmsAuthStrategyOptions
