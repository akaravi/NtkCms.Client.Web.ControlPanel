...
import { NbNtkcmsAuthStrategy } from './ntkcms-strategy';
...
describe('password-auth-strategy', () => {
  ...
  let strategy: NbNtkcmsAuthStrategy;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: NbNtkcmsAuthStrategy, useClass: NbNtkcmsAuthStrategy },
      ],
    });
  });

  beforeEach(async(inject(
    [NbNtkcmsAuthStrategy, HttpTestingController],
    (_strategy, _httpMock) => {
      strategy = _strategy;
      httpMock = _httpMock;
