...
/* Core Site */
export const CORE_SITE_ACT_GETALL = "CORE_SITE_ACT_GETALL";
export const CORE_SITE_ACT_GETALL_SUCCESS = "CORE_SITE_ACT_GETALL_SUCCESS";
export const CORE_SITE_ACT_GETALL_ERROR = "CORE_SITE_ACT_GETALL_ERROR";

export const CORE_SITE_ACT_GETONE = "CORE_SITE_ACT_GETONE";
export const CORE_SITE_ACT_GETONE_SUCCESS = "CORE_SITE_ACT_GETONE_SUCCESS";
export const CORE_SITE_ACT_GETONE_ERROR = "CORE_SITE_ACT_GETONE_ERROR";

export const CORE_SITE_ACT_UPDATE = "CORE_SITE_ACT_UPDATE";
export const CORE_SITE_ACT_UPDATE_SUCCESS = "CORE_SITE_ACT_UPDATE_SUCCESS";
export const CORE_SITE_ACT_UPDATE_ERROR = "CORE_SITE_ACT_UPDATE_ERROR";

export const CORE_SITE_ACT_DELETE = "CORE_SITE_ACT_DELETE";
export const CORE_SITE_ACT_DELETE_SUCCESS = "CORE_SITE_ACT_DELETE_SUCCESS";
export const CORE_SITE_ACT_DELETE_ERROR = "CORE_SITE_ACT_DELETE_ERROR";



/* Core User */
export const CORE_USER_ACT_SELECTCURRENTSITE = "CORE_USER_ACT_SELECTCURRENTSITE";
export const CORE_USER_ACT_SELECTCURRENTSITE_SUCCESS = "CORE_USER_ACT_SELECTCURRENTSITE_SUCCESS";
export const CORE_USER_ACT_SELECTCURRENTSITE_ERROR = "CORE_USER_ACT_SELECTCURRENTSITE_ERROR";

export const CORE_USER_ACT_GETALL = "CORE_USER_ACT_GETALL";
export const CORE_USER_ACT_GETALL_SUCCESS = "CORE_USER_ACT_GETALL_SUCCESS";
export const CORE_USER_ACT_GETALL_ERROR = "CORE_USER_ACT_GETALL_ERROR";

export const CORE_USER_ACT_GETONE = "CORE_USER_ACT_GETONE";
export const CORE_USER_ACT_GETONE_SUCCESS = "CORE_USER_ACT_GETONE_SUCCESS";
export const CORE_USER_ACT_GETONE_ERROR = "CORE_USER_ACT_GETONE_ERROR";

export const CORE_USER_ACT_UPDATE = "CORE_USER_ACT_UPDATE";
export const CORE_USER_ACT_UPDATE_SUCCESS = "CORE_USER_ACT_UPDATE_SUCCESS";
export const CORE_USER_ACT_UPDATE_ERROR = "CORE_USER_ACT_UPDATE_ERROR";

export const CORE_USER_ACT_DELETE = "CORE_USER_ACT_DELETE";
export const CORE_USER_ACT_DELETE_SUCCESS = "CORE_USER_ACT_DELETE_SUCCESS";
export const CORE_USER_ACT_DELETE_ERROR = "CORE_USER_ACT_DELETE_ERROR";
