app.controller("vehiclePropertyController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $window, $filter) {
    ...
    vehicleProperty.editRow = function (frm) {
        ...
        if (vehicleProperty.oldLinkPropertyTypeId != vehicleProperty.selectedItem.LinkPropertyTypeId) {
            ...
            ajax.call(mainPathApi+'VehiclePropertyDetailValue/deleteBatch', engine, 'DELETE').success(function (response) {
                rashaErManage.checkAction(response);
    ...
    //vehicleProperty.isloadind = true;
    //vehicleProperty.isNeighloadind = true;

    //vehicleProperty.onProvinceChange = function (provinceId) {
    //    vehicleProperty.cityCmsLocatinoListItems = [];//Clear previous cities
    //    vehicleProperty.neighbourhoodCmsLocatinoListItems = [];//Clear previous neighbourhoods
    //    var engine = {
    //    };
    //    var cityfilterModel = {
    ...
    //        vehicleProperty.isloadind = false;
    //        rashaErManage.checkAction(response);
    //        vehicleProperty.cityCmsLocatinoListItems = response.ListItems;
    //    }).error(function (data, errCode, c, d) {
    //        vehicleProperty.busyIndicator.isActive = false;
    //        rashaErManage.checkAction(data, errCode);
    //    });
    ...
    //vehicleProperty.onCitiesChange = function (cityId) {
    //    var engine = {
    //    };
    ...
    //        vehicleProperty.isNeighloadind = false;
    //        rashaErManage.checkAction(response);
    //        vehicleProperty.neighbourhoodCmsLocatinoListItems = response.ListItems;
    //    }).error(function (data, errCode, c, d) {
    //        vehicleProperty.busyIndicator.isActive = false;
    //        rashaErManage.checkAction(data, errCode);
    //    });
    ...
    vehicleProperty.replaceFile = function (name) {
        ...
        // Delete the file
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", vehicleProperty.fileIdToDelete, 'GET').success(function (response1) {
    ...
    vehicleProperty.saveNewFile = function () {
        ajax.call(mainPathApi+"CmsFileContent/add", vehicleProperty.FileItem, 'POST').success(function (response) {
            if (response.IsSuccess) {
