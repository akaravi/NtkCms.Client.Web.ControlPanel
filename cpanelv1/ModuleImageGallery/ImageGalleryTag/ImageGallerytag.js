...
//#help/ سلکتور دسته بندی در ویرایش محتوا
 imgGalleryTag.LinkCategoryTagIdSelector = {
    ...
    imgGalleryTag.replaceFile = function (name) {
        ...
        // Delete the file
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", imgGalleryTag.fileIdToDelete, 'GET').success(function (response1) {
    ...
    imgGalleryTag.saveNewFile = function () {
        ajax.call(mainPathApi+"CmsFileContent/add", imgGalleryTag.FileItem, 'POST').success(function (response) {
            if (response.IsSuccess) {
    ...
    imgGalleryTag.onSelection = function (node, selected) {
        ...
        imgGalleryTag.selectedItem.previewImageSrc = "CmsFiles/img/loader.gif";
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", node.Id, "GET").success(function (response) {
            imgGalleryTag.selectedItem.previewImageSrc = "/files/" + response.Item.Id + "/" + response.Item.FileName;
        }).error(function (data, errCode, c, d) {
            console.log(data);
        });
    }
