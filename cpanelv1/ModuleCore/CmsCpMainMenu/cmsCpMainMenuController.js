app.controller("cmsCpMainMenuGridCtrl", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $filter) {
    ...
    ajax.call(mainPathApi+"CmsUserGroup/getall", {}, 'POST').success(function (response) {
    ...
    cmsCpMainMenugrd.init = function () {
        ...
        ajax.call(mainPathApi+"cmsCpMainMenu/getAllMenuPlaceType", {}, 'POST').success(function (response) {
            cmsCpMainMenugrd.MenuPlaceType = response;
        }).error(function (data, errCode, c, d) {
            console.log(data);
        });
        ajax.call(mainPathApi+"cmsCpMainMenu/getAllMenu", cmsCpMainMenugrd.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
    ...
    cmsCpMainMenugrd.selectContent = function (node) {
        ...
        ajax.call(mainPathApi+"CmsCpMainMenu/GetAll", cmsCpMainMenugrd.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            cmsCpMainMenugrd.busyIndicator.isActive = false;
            cmsCpMainMenugrd.ListItems = response.ListItems;
    ...
    cmsCpMainMenugrd.openAddContentModal = function () {
        ...
        ajax.call(mainPathApi+'CmsCpMainMenu/getall', {}, 'POST').success(function (response) {
        ...
        ajax.call(mainPathApi+'cmsCpMainMenu/getviewmodel', '0', 'GET').success(function (response) {
            rashaErManage.checkAction(response);
    ...
    cmsCpMainMenugrd.addNewRow = function (frm) {
        ...
        ajax.call(mainPathApi+'cmsCpMainMenu/add', cmsCpMainMenugrd.selectedItem, 'POST').success(function (response) {
            cmsCpMainMenugrd.busyIndicator.isActive = false;
            cmsCpMainMenugrd.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    cmsCpMainMenugrd.openEditContentModal = function () {
        ...
        ajax.call(mainPathApi+'cmsCpMainMenu/getviewmodel', cmsCpMainMenugrd.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
    ...
    cmsCpMainMenugrd.editRow = function (frm) {
        if (frm.$invalid)
            return;
        cmsCpMainMenugrd.addRequested = true;
        ajax.call(mainPathApi+'cmscpmainMenu/edit', cmsCpMainMenugrd.selectedItem, 'PUT').success(function (response) {
            cmsCpMainMenugrd.addRequested = false;
            cmsCpMainMenugrd.busyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            if (response.IsSuccess) {
        ...
        rashaErManage.showYesNo(($filter('translate')('Warning')), ($filter('translate')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(mainPathApi+'cmsCpMainMenu/getviewmodel', cmsCpMainMenugrd.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(mainPathApi+'cmsCpMainMenu/delete', cmsCpMainMenugrd.selectedItemForDelete, 'DELETE').success(function (res) {
    ...
    cmsCpMainMenugrd.editStepGoUp = function (item, index) {
        ...
        ajax.call(mainPathApi+'cmscpmainmenu/getviewmodel', item.Id, 'GET').success(function (response1) {
            ...
            ajax.call(mainPathApi+'cmscpmainmenu/edit', cmsCpMainMenugrd.selectedItem, 'PUT').success(function (response2) {
                rashaErManage.checkAction(response2);
                if (response2.IsSuccess) {
                    ajax.call(mainPathApi+'cmscpmainmenu/getviewmodel', cmsCpMainMenugrd.gridOptions.data[index - 1].Id, 'GET').success(function (response3) {
                        ...
                        ajax.call(mainPathApi+'cmscpmainmenu/edit', cmsCpMainMenugrd.selectedItem, 'PUT').success(function (response4) {
