app.controller("cmsModuleGridCtrl", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$builder', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $builder, $window, $filter) {
    ...
    cmsModulegrd.init = function () {
        ...
        ajax.call(mainPathApi+"cmsModule/getall", cmsModulegrd.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
    ...
    cmsModulegrd.openAddModal = function () {
        ...
        ajax.call(mainPathApi+'cmsModule/getviewmodel', '0', 'GET').success(function (response) {
            rashaErManage.checkAction(response);
    ...
    cmsModulegrd.autoAdd = function () {
        ...
        cmsModulegrd.busyIndicator.isActive = true;
        ajax.call(mainPathApi+'cmsModule/AutoAdd', '', 'POST').success(function (response) {
            cmsModulegrd.addRequested = false;
            cmsModulegrd.busyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            cmsModulegrd.init();
    ...
    cmsModulegrd.addNewRow = function (frm) {
        ...
        ajax.call(mainPathApi+'cmsModule/add', cmsModulegrd.selectedItem, 'POST').success(function (response) {
    ...
    cmsModulegrd.openEditModal = function () {
        ...
        buttonIsPressed = true;
        ajax.call(mainPathApi+'cmsModule/getviewmodel', cmsModulegrd.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
    ...
    cmsModulegrd.editRow = function (frm) {
        ...
        ajax.call(mainPathApi+'cmsModule/edit', cmsModulegrd.selectedItem, 'PUT').success(function (response) {
            cmsModulegrd.addRequested = true;
            rashaErManage.checkAction(response);
            if (response.IsSuccess) {
                cmsModulegrd.addRequested = false;
        ...
        rashaErManage.showYesNo(($filter('translate')('Warning')), ($filter('translate')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(mainPathApi+'cmsModule/getviewmodel', cmsModulegrd.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(mainPathApi+'cmsModule/delete', cmsModulegrd.selectedItemForDelete, 'DELETE').success(function (res) {
    ...
    cmsModulegrd.getFromSystem = function () {
        ...
        cmsModulegrd.busyIndicator.isActive = true;
        ajax.call(mainPathApi+'cmsmodule/GetOneWithModuleConfig', model, 'POST').success(function (response) {
            cmsModulegrd.busyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            if (response.IsSuccess) {
                $builder.removeAllFormObject('default');
    ...
    cmsModulegrd.saveJsonForm = function () {
        ...
        model.Filters.push({ PropertyName: "Id", SearchType: 0, IntValue1: parseInt(cmsModulegrd.selectedItem.Id) });
        cmsModulegrd.busyIndicator.isActive = true;
        ajax.call(mainPathApi+'cmsmodule/GetOneWithModuleConfig', model, 'POST').success(function (response1) {
            cmsModulegrd.busyIndicator.isActive = false;
            ...
            cmsModulegrd.busyIndicator.isActive = true;
            ajax.call(mainPathApi+'cmsmodule/edit', cmsModulegrd.selectedItem, 'PUT').success(function (response2) {
    ...
    cmsModulegrd.exportFile = function () {
        ...
        ajax.call(mainPathApi+'cmsmodule/exportfile', cmsModulegrd.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            if (response.IsSuccess) {
    ...
    cmsModulegrd.getCount = function () {
        ajax.call(mainPathApi+"cmsmodule/count", cmsModulegrd.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
