app.controller("cmsModuleSaleInvoiceController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $window, $filter) {
    ...
    cmsModuleSaleInvoice.init = function () {
        ...
        ajax.call(mainPathApi+"CmsModuleSaleInvoice/getall", engine, 'POST').success(function (response) {
        ...
        //cmsModuleSaleInvoice.busyIndicator.isActive = true;
        //ajax.call(mainPathApi+'CmsModuleSaleInvoice/getall', {}, 'POST').success(function (response) {
    ...
    cmsModuleSaleInvoice.openAddModal = function () {
        ...
        ajax.call(mainPathApi+'CmsModuleSaleInvoice/getviewmodel', "0", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            cmsModuleSaleInvoice.busyIndicator.isActive = false;
    ...
    cmsModuleSaleInvoice.addNewRow = function (frm) {
        ...
        ajax.call(mainPathApi+'CmsModuleSaleInvoice/add', cmsModuleSaleInvoice.selectedItem, 'POST').success(function (response) {
            cmsModuleSaleInvoice.addRequested = false;
            cmsModuleSaleInvoice.busyIndicator.isActive = false;
            rashaErManage.checkAction(response);
    ...
    cmsModuleSaleInvoice.openEditModal = function () {
        ...
        ajax.call(mainPathApi+'CmsModuleSaleInvoice/getviewmodel', cmsModuleSaleInvoice.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            cmsModuleSaleInvoice.selectedItem = response.Item;
            $modal.open({
    ...
    cmsModuleSaleInvoice.editRow = function (frm) {
        ...
        cmsModuleSaleInvoice.busyIndicator.isActive = true;
        ajax.call(mainPathApi+'CmsModuleSaleInvoice/edit', cmsModuleSaleInvoice.selectedItem, 'PUT').success(function (response) {
            cmsModuleSaleInvoice.addRequested = true;
            rashaErManage.checkAction(response);
            cmsModuleSaleInvoice.busyIndicator.isActive = false;
            if (response.IsSuccess) {
        ...
        rashaErManage.showYesNo(($filter('translate')('Warning')), ($filter('translate')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(mainPathApi+'CmsModuleSaleInvoice/getviewmodel', cmsModuleSaleInvoice.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(mainPathApi+'CmsModuleSaleInvoice/delete', cmsModuleSaleInvoice.selectedItemForDelete, 'DELETE').success(function (res) {
...
ajax.call(mainPathApi+"CmsModuleSaleInvoiceDetail/getall", engine, "POST").success(function (response) {
...
cmsModuleSaleInvoice.gridOptionsDetail = {
    ...
    cmsModuleSaleInvoice.exportFile = function () {
        ...
        ajax.call(mainPathApi+'CmsModuleSaleInvoice/exportfile', cmsModuleSaleInvoice.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            cmsModuleSaleInvoice.addRequested = false;
            rashaErManage.checkAction(response);
            if (response.IsSuccess) {
    ...
    cmsModuleSaleInvoice.getCount = function () {
        ajax.call(mainPathApi+"CmsModuleSaleInvoice/count", cmsModuleSaleInvoice.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            cmsModuleSaleInvoice.addRequested = false;
            rashaErManage.checkAction(response);
