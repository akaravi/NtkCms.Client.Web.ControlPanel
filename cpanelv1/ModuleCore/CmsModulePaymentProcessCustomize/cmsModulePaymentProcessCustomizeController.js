app.controller("cmsModulePaymentProcessCustomizeCtrl", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$builder', '$stateParams', '$state', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $builder, $stateParams, $state, $filter) {
    ...
    cmsMdlPayPrcCust.init = function () {
        ...
        ajax.call(mainPathApi+"CmsModulePaymentProcessCustomize/getall", cmsMdlPayPrcCust.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
        ...
        ajax.call(mainPathApi+"CmsModulePaymentProcess/getAll", {}, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
    ...
    cmsMdlPayPrcCust.onModuleChange = function (moduleId) {
        ...
        cmsMdlPayPrcCust.isLoading = true;
        ajax.call(mainPathApi+"CmsModulePaymentProcess/GetAll", cmsMdlPayPrcCust.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
