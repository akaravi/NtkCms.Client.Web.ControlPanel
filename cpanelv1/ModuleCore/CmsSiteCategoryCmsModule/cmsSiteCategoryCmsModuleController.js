app.controller("cmsSiteCategoryCmsModuleCtrl", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$builder', '$rootScope', '$window', '$state', '$stateParams', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $builder, $rootScope, $window, $state, $stateParams, $filter) {
    ...
    cmsSiteCategoryCmsModule.init = function () {
        ...
        ajax.call(mainPathApi+"cmssitecategorycmsmodule/getall", cmsSiteCategoryCmsModule.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
        ...
        ajax.call(mainPathApi+"cmssitecategory/getall", filterModel, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            cmsSiteCategoryCmsModule.categoryListItems = response.ListItems;
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
        });
        ajax.call(mainPathApi+"cmsmodule/getall", filterModel, 'POST').success(function (response) {
    ...
    cmsSiteCategoryCmsModule.openAddModal = function () {
        ...
        ajax.call(mainPathApi+'cmssitecategorycmsmodule/getviewmodel', "0", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
    ...
    cmsSiteCategoryCmsModule.addNewRow = function (frm) {
        ...
        ajax.call(mainPathApi+'CmsSiteCategoryCmsModule/add', cmsSiteCategoryCmsModule.selectedItem, 'POST').success(function (response) {
            cmsSiteCategoryCmsModule.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    cmsSiteCategoryCmsModule.openEditModal = function () {
        ...
        ajax.call(mainPathApi+'CmsSiteCategoryCmsModule/getviewmodel', cmsSiteCategoryCmsModule.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            cmsSiteCategoryCmsModule.selectedItem = response.Item;
            $modal.open({
    ...
    cmsSiteCategoryCmsModule.editRow = function (frm) {
        if (frm.$invalid)
            return;
        cmsSiteCategoryCmsModule.busyIndicator.isActive = true;
        ajax.call(mainPathApi+'CmsSiteCategoryCmsModule/edit', cmsSiteCategoryCmsModule.selectedItem, 'PUT').success(function (response) {
            cmsSiteCategoryCmsModule.addRequested = true;
            rashaErManage.checkAction(response);
            if (response.IsSuccess) {
        ...
        rashaErManage.showYesNo(($filter('translate')('Warning')), ($filter('translate')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ajax.call(mainPathApi+'CmsSiteCategoryCmsModule/getviewmodel', cmsSiteCategoryCmsModule.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(mainPathApi+'CmsSiteCategoryCmsModule/delete', cmsSiteCategoryCmsModule.selectedItemForDelete, 'DELETE').success(function (res) {
    ...
    cmsSiteCategoryCmsModule.saveSubmitValues = function () {
        ...
        ajax.call(mainPathApi+'CmsModuleSite/edit', cmsSiteCategoryCmsModule.cmsModuleSite, 'PUT').success(function (response) {
            rashaErManage.checkAction(response);
            if (response.IsSuccess) {
                cmsSiteCategoryCmsModule.closeModal();
            }
    ...
    cmsSiteCategoryCmsModule.exportFile = function () {
        ...
        ajax.call(mainPathApi+'CmsSiteCategoryCmsModule/exportfile', cmsSiteCategoryCmsModule.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            if (response.IsSuccess) {
    ...
    cmsSiteCategoryCmsModule.getCount = function () {
        ajax.call(mainPathApi+"CmsSiteCategoryCmsModule/count", cmsSiteCategoryCmsModule.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
