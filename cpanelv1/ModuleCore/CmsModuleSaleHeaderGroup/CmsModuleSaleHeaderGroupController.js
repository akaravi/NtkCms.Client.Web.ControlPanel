app.controller("CmsModuleSaleHeaderGroupController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $window, $filter) {
    ...
    CmsModuleHeaderG.init = function () {
        ...
        ajax.call(mainPathApi+"CmsModuleSaleHeaderGroup/getall", engine, 'POST').success(function (response) {
        ...
        //CmsModuleHeaderG.busyIndicator.isActive = true;
        //ajax.call(mainPathApi+'CmsModuleSaleHeaderGroup/getall', {}, 'POST').success(function (response) {
    ...
    CmsModuleHeaderG.openAddModal = function () {
        ...
        ajax.call(mainPathApi+'CmsModuleSaleHeaderGroup/getviewmodel', "0", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            CmsModuleHeaderG.busyIndicator.isActive = false;
    ...
    CmsModuleHeaderG.addNewRow = function (frm) {
        ...
        ajax.call(mainPathApi+'CmsModuleSaleHeaderGroup/add', CmsModuleHeaderG.selectedItem, 'POST').success(function (response) {
            CmsModuleHeaderG.addRequested = false;
            CmsModuleHeaderG.busyIndicator.isActive = false;
            rashaErManage.checkAction(response);
    ...
    CmsModuleHeaderG.openEditModal = function () {
        ...
        ajax.call(mainPathApi+'CmsModuleSaleHeaderGroup/getviewmodel', CmsModuleHeaderG.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            CmsModuleHeaderG.selectedItem = response.Item;
            $modal.open({
    ...
    CmsModuleHeaderG.editRow = function (frm) {
        ...
        CmsModuleHeaderG.busyIndicator.isActive = true;
        ajax.call(mainPathApi+'CmsModuleSaleHeaderGroup/edit', CmsModuleHeaderG.selectedItem, 'PUT').success(function (response) {
            CmsModuleHeaderG.addRequested = true;
            rashaErManage.checkAction(response);
            CmsModuleHeaderG.busyIndicator.isActive = false;
            if (response.IsSuccess) {
        ...
        rashaErManage.showYesNo(($filter('translate')('Warning')), ($filter('translate')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(mainPathApi+'CmsModuleSaleHeaderGroup/getviewmodel', CmsModuleHeaderG.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(mainPathApi+'CmsModuleSaleHeaderGroup/delete', CmsModuleHeaderG.selectedItemForDelete, 'DELETE').success(function (res) {
 ...
 CmsModuleHeaderG.LinkCmsSiteCategoryIdSelector = {
    ...
    CmsModuleHeaderG.exportFile = function () {
        ...
        ajax.call(mainPathApi+'CmsModuleSaleHeaderGroup/exportfile', CmsModuleHeaderG.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            CmsModuleHeaderG.addRequested = false;
            rashaErManage.checkAction(response);
            if (response.IsSuccess) {
    ...
    CmsModuleHeaderG.getCount = function () {
        ajax.call(mainPathApi+"CmsModuleSaleHeaderGroup/count", CmsModuleHeaderG.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            CmsModuleHeaderG.addRequested = false;
            rashaErManage.checkAction(response);
