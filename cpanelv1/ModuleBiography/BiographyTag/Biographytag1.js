...
//#help/ سلکتور دسته بندی در ویرایش محتوا
 biographyTag.LinkCategoryTagIdSelector = {
    ...
    biographyTag.replaceFile = function (name) {
        ...
        // Delete the file
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", biographyTag.fileIdToDelete, 'GET').success(function (response1) {
    ...
    biographyTag.saveNewFile = function () {
        ajax.call(mainPathApi+"CmsFileContent/add", biographyTag.FileItem, 'POST').success(function (response) {
            if (response.IsSuccess) {
    ...
    biographyTag.onSelection = function (node, selected) {
        ...
        biographyTag.selectedItem.previewImageSrc = "CmsFiles/img/loader.gif";
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", node.Id, "GET").success(function (response) {
            biographyTag.selectedItem.previewImageSrc = "/files/" + response.Item.Id + "/" + response.Item.FileName;
        }).error(function (data, errCode, c, d) {
            console.log(data);
        });
    }
