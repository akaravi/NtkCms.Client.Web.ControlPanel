...
//#help/ سلکتور دسته بندی در ویرایش محتوا
 mscGalleryTag.LinkCategoryTagIdSelector = {
    ...
    mscGalleryTag.replaceFile = function (name) {
        ...
        // Delete the file
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", mscGalleryTag.fileIdToDelete, 'GET').success(function (response1) {
    ...
    mscGalleryTag.saveNewFile = function () {
        ajax.call(mainPathApi+"CmsFileContent/add", mscGalleryTag.FileItem, 'POST').success(function (response) {
            if (response.IsSuccess) {
    ...
    mscGalleryTag.onSelection = function (node, selected) {
        ...
        mscGalleryTag.selectedItem.previewImageSrc = "CmsFiles/img/loader.gif";
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", node.Id, "GET").success(function (response) {
            mscGalleryTag.selectedItem.previewImageSrc = "/files/" + response.Item.Id + "/" + response.Item.FileName;
        }).error(function (data, errCode, c, d) {
            console.log(data);
        });
    }
