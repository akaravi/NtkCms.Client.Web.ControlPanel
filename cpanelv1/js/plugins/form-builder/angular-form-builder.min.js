            ...
            function ($http) {
                return {
                    ...
                    link: function (scope, elem, attrs) {
                        ...
                        $http({
                            'method': 'POST',
                            'url': mainPathApi +'CmsModule/getall',
                            'data': {},
                            'async': false,
                            'headers': {
                        ...
                        scope.moduleListSelectFun = function (newValue) {
                            ...
                            if (angular.isDefined(newValue)) {
                                $http({
                                    'method': 'POST',
                                    'url': mainPathApi +'CmsModuleProcess/getall',
                                    'data': engine,
                                    'async': false,
                                    'headers': {
                                        'Content-Type': 'application/json',
                        ...
                        scope.processListSelectFun = function (newValue) {
                            ...
                            if (angular.isDefined(newValue)) {
                                $http({
                                    'method': 'POST',
                                    'url': mainPathApi +'CmsModuleProcessCustomize/getall',
                                    'data': engine,
                                    'async': false,
                                    'headers': {
                                        'Content-Type': 'application/json',
                        ...
                        scope.processCustomizeListSelectFun = function (newValue) {
                            ...
                            if (angular.isDefined(newValue)) {
                                $http({
                                    'method': 'POST',
                                    'url': mainPathApi +'UniversalMenuProcesses/getall',
                                    'data': engine,
                                    'async': false,
                                    'headers': {
                                        'Content-Type': 'application/json',
