        ...
        return {
            ...
            link: function(scope, element, attrs, ctrls) {
                ...
                scope.updateMasterValue = function(newDate, releaseTheBeast) {
                    ...
                    scope.$applyAsync(function() {
                        ...
                        scope.fullData = {
                            ...
                            UTCtime: scope.dtpValue.fullDate.getTimezoneOffset(),
                            dbDate: new Date(scope.dtpValue.fullDate.getTime() + (scope.dtpValue.fullDate.getTimezoneOffset() * -60000)), //scope.dtpValue.fullDate.toUTCString(),
                        ...
                        scope.ngModelDb = scope.fullData.dbDate;
                ...
                scope.parseInputValue = function(valueStr, resetTime, releaseTheBeast) {
                    ...
                    else if (valueStr && typeof valueStr == "string") {
                        valueStr = new Date(valueStr).getTime();
                    }
                    var _dateTime = false;
                ...
                scope.parseInputValue(scope.ngModelDb || ngModel.$viewValue || scope.option.default, true, false);
                
                ngModel.$formatters.push(function (val) {
                    if (!val && scope.dtpValue.unix && !scope.ngModelDb) {
                        scope.destroy();
                    }
