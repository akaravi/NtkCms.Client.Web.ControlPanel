    ...
    .config([
        ...
        function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
            ...
            $stateProvider
                ...
                .state("user_wizard",
                    {
                        ...
                        data: { pagetTitle: "New User", specialClass: "gray-bg" },
                        resolve: {
                            deps: [
                                '$ocLazyLoad',
                                function ($ocLazyLoad) {
                ...
                .state("index.cmsuserbadlogingrd",
                    {
                        ...
                        data: { pageTitle: "لاگین های نادرست" },
                        ncyBreadcrumb: {
                ...
                .state("index.cmsusergroup",
                    {
                        ...
                        data: { pageTitle: "گروه بندی کاربران" },
                        ncyBreadcrumb: {
                ...
                .state("index.domainaliases",
                    {
                        ...
                        data: { pageTitle: "های دامنه Alias" },
                        ncyBreadcrumb: {
                ...
                .state("index.cmssitecategories",
                    {
                        ...
                        data: { pageTitle: "دسته بندی سایت ها" },
                        ncyBreadcrumb: {
                ...
                .state("index.cmspagecategories",
                    {
                        url: "/cmspagecategories",
                        templateUrl: "cpanelv1/ModuleCore/cmsPageCategory/grid.html",
                        controller: "cmsPageCategoryGridCtrl",
                        controllerAs: "cmsPageCategorygrd",
                        data: { pageTitle: "دسته بندی صفحات" },
                        ncyBreadcrumb: {
                            ...
                            deps: [
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load({
                                        serie: true,
                                        files: [
                                            'cpanelv1/ModuleCore/cmsPageCategory/cmsPageCategoryController.js'
                                        ]
                                    });
                                }
                            ]
                ...
                .state("index.modulesaleprice",
                    {
                        ...
                        data: { pageTitle: "قیمت فروش ماژول" },
                        ncyBreadcrumb: {
                ...
                .state("index.cmsmodulescheduleprocesscustomize",
                    {
                        ...
                        data: { pageTitle: "بکارگیری فعالیت پرداخت" },
                        ncyBreadcrumb: {
                ...
                .state('index.cmsapipath',
                    {
                        ...
                        controllerAs: "api",
                        data: { pageTitle: 'مسیر های ارسال پیام کوتاه' },
                        ncyBreadcrumb: {
                ...
                .state('index.cmsapicompany',
                    {
                        ...
                        data: { pageTitle: 'شرکت های پیام کوتاه' },
                        ncyBreadcrumb: {
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        "ngTagsInput", "summernote", "treeControl", 'ADM-dateTimePicker',{
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleNews/NewsContent/newsContents.js'
                                            ]
                                        }
                                    ]);
                                }
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        "ngTagsInput", "summernote", "treeControl", 'ADM-dateTimePicker', {
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleArticle/ArticleContent/ArticleContentsController.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.deliveryinvoice',
                    {
                        ...
                        data: { pageTitle: 'deliveryInvoice' },
                        ncyBreadcrumb: {
                ...
                .state('index.deliverymemberabsent',
                    {
                        ...
                        data: { pageTitle: 'DeliveryMemberAbsent' },
                        ncyBreadcrumb: {
                ...
                .state('index.deliverymembersetting',
                    {
                        ...
                        data: { pageTitle: 'deliveryMemberSetting' },
                        ncyBreadcrumb: {
                ...
                .state('index.deliverymethoddetail',
                    {
                        ...
                        data: { pageTitle: 'deliveryMethodDetail' },
                        ncyBreadcrumb: {
                ...
                .state('index.biographytag',
                    {
                        ...
                        data: { pageTitle: 'زندگی نامه - تگ ها' },
                        ncyBreadcrumb: {
                            label: 'تگ ها'
                        },
                        resolve: {
                ...
                .state('index.biographycomment',
                    {
                        ...
                        data: { pageTitle: 'زندگی نامه | کامنت' },
                        ncyBreadcrumb: {
                ...
                .state('index.productcomment',
                    {
                        ...
                        controllerAs: "ProductComment",
                        data: { pageTitle: 'محصولات | کامنت' },
                        ncyBreadcrumb: {
                            label: 'کامنت محصولات'
                        },
                        resolve: {
                ...
                .state('index.imagegallerycomment',
                    {
                        ...
                        data: { pageTitle: 'گالری تصاویر | کامنت' },
                        ncyBreadcrumb: {
                ...
                .state('index.musicgallerycomment',
                    {
                        ...
                        data: { pageTitle: 'گالری موسیقی | کامنت' },
                        ncyBreadcrumb: {
                ...
                .state('index.moviegallerycomment',
                    {
                        ...
                        data: { pageTitle: 'گالری فیلم | کامنت' },
                        ncyBreadcrumb: {
                ...
                .state('index.biographycontent',
                    {
                        ...
                        controller: "biographyContentCtrl",
                        controllerAs: "biographyContent",
                        data: { pageTitle: 'زندگی نامه | محتوا' },
                        ncyBreadcrumb: {
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        "ngTagsInput", "summernote", "treeControl", 'ADM-dateTimePicker',{
                                            //serie: true,
                                            files: [
                                                'cpanelv1/ModuleBiography/BiographyContent/BiographyContents.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.pollingoption',
                    {
                        ...
                        data: { pageTitle: 'نظرسنجی | گزینه ها' },
                        ncyBreadcrumb: {
                            label: 'گزینه ها'
                        },
                        resolve: {
                ...
                .state('index.pollingcontent',
                    {
                        ...
                        data: { pageTitle: 'نظرسنجی | مدیریت نظرسنجی' },
                        ncyBreadcrumb: {
                            label: 'نظرسنجی'
                        },
                        resolve: {
                ...
                .state('index.pollinglog',
                    {
                        ...
                        data: { pageTitle: 'نظرسنجی | گزارش آرا' },
                        ncyBreadcrumb: {
                            label: 'گزارش آرا'
                        },
                        resolve: {
                ...
                .state('index.imagegallery',
                    {
                        ...
                        data: { pageTitle: 'صفحه مدیریت تصاویر' },
                        ncyBreadcrumb: {
                            label: 'مدیریت تصاویر'
                        },
                        resolve: {
                ...
                .state('index.moviegallery',
                    {
                        ...
                        data: { pageTitle: 'صفحه مدیریت فیلم ها' },
                        ncyBreadcrumb: {
                ...
                .state('index.musicgallery',
                    {
                        ...
                        data: { pageTitle: 'صفحه مدیریت موسیقی ها' },
                        ncyBreadcrumb: {
                ...
                .state('index.linkmanagementdashboard',
                    {
                        ...
                        data: { pageTitle: 'داشبورد تبادل لینک' },
                        ncyBreadcrumb: {
                            label: 'تبادل لینک'
                        },
                        resolve: {
                ...
                .state('index.ticket',
                    {
                        url: "/ticket",
                        params: { Unreadticket: false },
                        templateUrl: "cpanelv1/ModuleTicketing/Ticket/grid.html",
                        controller: "ticketController",
                        controllerAs: "ticket",
                        data: { pageTitle: 'مدیریت تیکت ها' },
                        ncyBreadcrumb: {
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        'ngJsTree', 'summernote', {
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleTicketing/Ticket/ticket.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.ticketanswer',
                    {
                        url: "/ticketanswer",
                        templateUrl: "cpanelv1/ModuleTicketing/TicketAnswer/grid.html",
                        controller: "ticketAnswerController",
                        controllerAs: "ticketAnswer",
                        data: { pageTitle: 'پاسخ ها' },
                        ncyBreadcrumb: {
                            label: 'پاسخ ها'
                        },
                        resolve: {
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        'ngJsTree', 'summernote', {
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleTicketing/ticketAnswer.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.tickettype',
                    {
                        url: "/tickettype",
                        templateUrl: "cpanelv1/ModuleTicketing/TicketType/grid.html",
                        controller: "ticketTypeController",
                        controllerAs: "tickeType",
                        data: { pageTitle: 'مدیریت بخش ها' },
                        ncyBreadcrumb: {
                            label: 'مدیریت بخش ها'
                        },
                        resolve: {
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        'summernote', {
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleTicketing/TicketType/ticketType.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.faq',
                    {
                        url: "/faq",
                        templateUrl: "cpanelv1/ModuleTicketing/Faq/grid.html",
                        controller: "faqController",
                        controllerAs: "faq",
                        data: { pageTitle: 'سوالات متداول' },
                        ncyBreadcrumb: {
                            label: 'سوالات متداول'
                        },
                        resolve: {
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        'ngJsTree', 'summernote', {
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleTicketing/Faq/faq.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.apitelegramloginput',
                    {
                        ...
                        data: { pageTitle: 'گزارش پیام های ورودی' },
                        ncyBreadcrumb: {
                ...
                .state('index.apitelegramlogoutput',
                    {
                        ...
                        data: { pageTitle: 'گزارش پیام های خروجی' },
                        ncyBreadcrumb: {
                ...
                .state('index.apitelegramuploadedfiles',
                    {
                        ...
                        data: { pageTitle: 'فایل های آپلود شده' },
                        ncyBreadcrumb: {
                ...
                .state('index.apitelegramreceivedfiles',
                    {
                        ...
                        data: { pageTitle: 'فایل های دریافتی' },
                        ncyBreadcrumb: {
                ...
                .state('index.reservationcontent',
                    {
                        ...
                        data: { pageTitle: 'محتوای رزرواسیون' },
                        ncyBreadcrumb: {
                ...
                .state('index.reservationcomment',
                    {
                        ...
                        data: { pageTitle: 'رزرواسیون-کامنت' },
                        ncyBreadcrumb: {
                ...
                .state('index.reservationappointmentdate',
                    {
                        ...
                        data: { pageTitle: 'اعلام رزرواسیون' },
                        ncyBreadcrumb: {
                ...
                .state('index.reservationtag',
                    {
                        ...
                        data: { pageTitle: 'تگهای رزرواسیون' },
                        ncyBreadcrumb: {
                            label: 'تگ رزرواسیون'
                        },
                        resolve: {
                ...
                //-----MobileApp Module-----
                .state('index.mobileappapplication',
                    {
                        url: "/mobileappapplication",
                        templateUrl: "cpanelv1/ModuleMobileApp/MobileAppApplication/grid.html",
                        controller: "mobileAppApplicationController",
                        controllerAs: "themeConfig",
                        data: { pageTitle: 'اپلیکشین ها' },
                        ncyBreadcrumb: {
                            label: 'اپلیکشین ها'
                        },
                        resolve: {
                            deps: [
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        'monospaced.qrcode', 'treeControl', {
                                            serie: true,
                                            files: [
                                                'cpanelv1/ModuleMobileApp/MobileAppApplication/MobileAppApplicationController.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.mobileappsource',
                    {
                        url: "/mobileappsource",
                        templateUrl: "cpanelv1/ModuleMobileApp/MobileAppSource/grid.html",
                        controller: "mobileAppSourceController",
                        controllerAs: "appSource",
                        data: { pageTitle: 'منابع' },
                        ncyBreadcrumb: {
                            label: 'منابع'
                        },
                        resolve: {
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        'angucomplete-alt', {
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleMobileApp/MobileAppSource/MobileAppSourceController.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.mobileapplayout',
                    {
                        url: "/mobileapplayout",
                        templateUrl: "cpanelv1/ModuleMobileApp/MobileAppLayout/grid.html",
                        params: { sourceid: null },
                        controller: "mobileAppLayoutController",
                        controllerAs: "appLayout",
                        data: { pageTitle: 'نیازمندی صفحات' },
                        ncyBreadcrumb: {
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        'treeControl', {
                                            serie: true,
                                            files: [
                                                'cpanelv1/ModuleMobileApp/MobileAppLayout/MobileAppLayoutController.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.mobileapplayoutvalue',
                    {
                        url: "/mobileapplayoutvalue",
                        templateUrl: "cpanelv1/ModuleMobileApp/MobileAppLayoutValue/grid.html",
                        params: { sourceid: null, appid: null, apptitle: null },
                        controller: "mobileAppLayoutValueController",
                        controllerAs: "appLayoutValue",
                        data: { pageTitle: 'مقداردهی به صفحات' },
                        ncyBreadcrumb: {
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        'angucomplete-alt', {
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleMobileApp/MobileAppLayoutValue/MobileAppLayoutValueController.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.mobileappthemeconfig',
                    {
                        url: "/mobileappthemeconfig",
                        templateUrl: "cpanelv1/ModuleMobileApp/MobileAppThemeConfig/grid.html",
                        controller: "themeConfigController",
                        controllerAs: "themeConfig",
                        data: { pageTitle: 'رنگ بندی' },
                        ncyBreadcrumb: {
                            label: 'رنگ بندی'
                        },
                        resolve: {
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        'nouislider', 'minicolors', {
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleMobileApp/MobileAppThemeConfig/MobileAppThemeConfigController.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.mobileappmemberinfo',
                    {
                        url: "/mobileappmemberinfo",
                        templateUrl: "cpanelv1/ModuleMobileApp/MobileAppMemberInfo/grid.html",
                        controller: "memberInfoController",
                        controllerAs: "memberInfo",
                        data: { pageTitle: 'کاربران' },
                        ncyBreadcrumb: {
                                    ...
                                    return $ocLazyLoad.load([
                                        {
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleMobileApp/MobileAppMemberInfo/MobileAppMemberInfoController.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.mobileapplognotification',
                    {
                        url: "/mobileapplogNotification",
                        templateUrl: "cpanelv1/ModuleMobileApp/MobileApplogNotification/grid.html",
                        controller: "logNotificationController",
                        controllerAs: "logNotification",
                        data: { pageTitle: 'نوتیفیکیشن' },
                        ncyBreadcrumb: {
                            label: 'نوتیفیکیشن'
                        },
                        resolve: {
                                    ...
                                    return $ocLazyLoad.load([
                                        {
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleMobileApp/MobileApplogNotification/mobileApplogNotificationController.js'
                                            ]
                                        }
                                    ]);
                                }
                ...
                .state('index.blogcontent',
                    {
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        "ngTagsInput", "summernote", "treeControl", 'ADM-dateTimePicker', {
                                            serie: false,
                                            files: [
                                                'cpanelv1/ModuleBlog/BlogContent/BlogContents.js'
                                            ]
                                        }
                                    ]);
                                }
                        ...
                        //        function ($ocLazyLoad) {
                        //            return $ocLazyLoad.load([
                        //                'ngTagsInput', 'summernote', 'nouislider', 'minicolors', 'angucomplete-alt',  {
                        //                    serie: false,
                        //                    files: [
                        //                        'cpanelv1/ModuleBlog/BlogContent/BlogContents.js'
                        //                      //  
                ...
                .state('index.advertisementcontract',
                    {
                        ...
                        data: { pageTitle: 'ماژول نیازمندی ها | قراردادها' },
                        ncyBreadcrumb: {
                            label: 'قرارداد ها'
                        },
                        resolve: {
                ...
                .state('index.advertisementcontracttype',
                    {
                        ...
                        data: { pageTitle: 'ماژول نیازمندی ها | نوع آگهی' },
                        ncyBreadcrumb: {
                            label: 'نوع آگهی'
                        },
                        resolve: {
                ...
                .state('index.advertisementproperty',
                    {
                        ...
                        data: { pageTitle: 'ماژول نیازمندی ها | مدیریت آگهی ها' },
                        ncyBreadcrumb: {
                ...
                .state('index.advertisementpropertydetail',
                    {
                        ...
                        data: { pageTitle: 'ماژول نیازمندی ها | خصوصیات آگهی ' },
                        ncyBreadcrumb: {
                            label: 'خصوصیات آگهی'
                        },
                        resolve: {
                ...
                .state('index.advertisementpropertydetailgroup',
                    {
                        ...
                        data: { pageTitle: 'ماژول نیازمندی ها | گروه بندی خصوصیات' },
                        ncyBreadcrumb: {
                ...
                .state('index.advertisementpropertyfavorite',
                    {
                        ...
                        data: { pageTitle: 'ماژول نیازمندی ها | آگهی های موردپسند' },
                        ncyBreadcrumb: {
                ...
                .state('index.estatecontract',
                    {
                        ...
                        data: { pageTitle: 'ماژول املاک | آگهی ها' },
                        ncyBreadcrumb: {
                            label: 'آگهی ها'
                        },
                        resolve: {
                ...
                .state('index.estatecontracttype',
                    {
                        ...
                        data: { pageTitle: 'ماژول املاک | نوع آگهی' },
                        ncyBreadcrumb: {
                            label: 'نوع آگهی'
                        },
                        resolve: {
                ...
                .state('index.estateproperty',
                    {
                        ...
                        data: { pageTitle: 'ماژول املاک | مدیریت املاک' },
                        ncyBreadcrumb: {
                            label: 'مدیریت املاک'
                        },
                        resolve: {
                ...
                .state('index.estatepropertydetail',
                    {
                        ...
                        data: { pageTitle: 'ماژول املاک | خصوصیات ' },
                        ncyBreadcrumb: {
                            label: 'خصوصیات ملک'
                        },
                        resolve: {
                ...
                .state('index.estatepropertydetailgroup',
                    {
                        ...
                        data: { pageTitle: 'ماژول املاک | گروه بندی خصوصیات' },
                        ncyBreadcrumb: {
                ...
                .state('index.estatepropertytype',
                    {
                        ...
                        data: { pageTitle: 'ماژول املاک | نوع ملک' },
                        ncyBreadcrumb: {
                ...
                .state('index.vehiclecontract',
                    {
                        ...
                        data: { pageTitle: 'ماژول آگهی خودرو | آگهی ها' },
                        ncyBreadcrumb: {
                            label: 'آگهی ها'
                        },
                        resolve: {
                ...
                .state('index.vehiclecontracttype',
                    {
                        ...
                        data: { pageTitle: 'ماژول آگهی خودرو | نوع آگهی' },
                        ncyBreadcrumb: {
                            label: 'نوع آگهی'
                        },
                        resolve: {
                ...
                .state('index.vehicleproperty',
                    {
                        ...
                        data: { pageTitle: 'ماژول آگهی خودرو | مدیریت آگهی ها' },
                        ncyBreadcrumb: {
                            label: 'مدیریت آگهی ها'
                        },
                        resolve: {
                ...
                .state('index.vehiclepropertydetail',
                    {
                        ...
                        data: { pageTitle: 'ماژول آگهی خودرو | خصوصیات ' },
                        ncyBreadcrumb: {
                            label: 'خصوصیات خودرو'
                        },
                        resolve: {
                ...
                .state('index.vehiclepropertydetailgroup',
                    {
                        ...
                        data: { pageTitle: 'ماژول آگهی خودرو | گروه بندی خصوصیات' },
                        ncyBreadcrumb: {
                ...
                .state('index.vehiclepropertytype',
                    {
                        ...
                        data: { pageTitle: 'ماژول آگهی خودرو | نوع خودرو' },
                        ncyBreadcrumb: {
                ...
                .state('index.jobcontract',
                    {
                        ...
                        data: { pageTitle: 'ماژول مشاغل | قراردادها' },
                        ncyBreadcrumb: {
                            label: 'قراردادها'
                        },
                        resolve: {
                ...
                .state('index.jobcontracttype',
                    {
                        ...
                        data: { pageTitle: 'ماژول مشاغل | نوع قرارداد' },
                        ncyBreadcrumb: {
                            label: 'نوع قرارداد'
                        },
                        resolve: {
                ...
                .state('index.jobproperty',
                    {
                        ...
                        data: { pageTitle: 'ماژول مشاغل | مدیریت متقاضیان' },
                        ncyBreadcrumb: {
                ...
                .state('index.jobpropertydetail',
                    {
                        ...
                        data: { pageTitle: 'ماژول مشاغل | خصوصیات ' },
                        ncyBreadcrumb: {
                ...
                .state('index.jobpropertydetailgroup',
                    {
                        ...
                        data: { pageTitle: 'ماژول مشاغل | گروه بندی خصوصیات' },
                        ncyBreadcrumb: {
                ...
                .state('index.jobpropertytype',
                    {
                        ...
                        data: { pageTitle: 'ماژول مشاغل | نوع متقاضی' },
                        ncyBreadcrumb: {
                ...
                .state('index.productcontentother',
                    {
                        ...
                        data: { pageTitle: 'محصولات-دسته بندی' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.productssharesetting',
                    {
                        ...
                        data: { pageTitle: 'محصولات-تنظیمات اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.servicetag',
                    {
                        ...
                        controller: "serviceTagContorller",
                        controllerAs: "serviceTag",
                        data: { pageTitle: 'خدمات - تگ ها' },
                        ncyBreadcrumb: {
                            label: 'تگ ها'
                        },
                        resolve: {
                ...
                .state('index.servicecontent',
                    {
                        ...
                        controller: "serviceContentCtrl",
                        controllerAs: "serviceContent",
                        data: { pageTitle: 'خدمات | محتوا' },
                        ncyBreadcrumb: {
                            label: 'محتوای خدمات'
                        },
                        resolve: {
                ...
                .state('index.memberproperty',
                    {
                        ...
                        params: { memberuserId: null },
                        controller: "memberPropertyController",
                        controllerAs: "memberProperty",
                        data: { pageTitle: 'ماژول اشخاص | مدیریت پرونده' },
                        ncyBreadcrumb: {
                            label: 'مدیریت پرونده'
                        },
                        resolve: {
                ...
                .state('index.memberpropertydetail',
                    {
                        ...
                        data: { pageTitle: 'ماژول اشخاص | خصوصیات ' },
                        ncyBreadcrumb: {
                ...
                .state('index.memberpropertydetailgroup',
                    {
                        ...
                        data: { pageTitle: 'ماژول اشخاص | گروه بندی خصوصیات' },
                        ncyBreadcrumb: {
                ...
                .state('index.memberpropertytypesite',
                    {
                        ...
                        data: { pageTitle: 'ماژول اشخاص | دسترسی ' },
                        ncyBreadcrumb: {
                ...
                .state('index.objectpropertydetailgroup',
                    {
                        ...
                        data: { pageTitle: 'ماژول اشیا | گروه بندی خصوصیات' },
                        ncyBreadcrumb: {
                ...
                .state('index.objectpropertytype',
                    {
                        ...
                        data: { pageTitle: 'ماژول اشیا | نوع اشیا' },
                        ncyBreadcrumb: {
                ...
                .state("index.shopcontent",
                    {
                        ...
                        data: { pageTitle: "دسته بندی کالا ها" },
                        ncyBreadcrumb: {
                ...
                .state("index.shopinvoicesaleworkflow",
                    {
                        ...
                        data: { pageTitle: "shopInvoiceSaleWorkFlow" },
                        ncyBreadcrumb: {
                ...
                .state("index.shopproductfileserial",
                    {
                        ...
                        data: { pageTitle: "shopProductFileSerial" },
                        ncyBreadcrumb: {
                ...
                .state("index.shopprocesscategory",
                    {
                        ...
                        data: { pageTitle: "shopProcessCategory" },
                        ncyBreadcrumb: {
                ...
                .state("index.bankpaymenttransc",
                    {
                        ...
                        controllerAs: "transc",
                        params: { privateSiteConfigId: null, transactionId: 0 },
                        data: { pageTitle: "تراکنش ها" },
                        ncyBreadcrumb: {
                            label: 'تراکنش ها'
                        },
                        resolve: {
                ...
                .state("index.bankpaymenttransclog",
                    {
                        ...
                        data: { pageTitle: "جزییات تراکنش ها" },
                        ncyBreadcrumb: {
                ...
                .state('index.phonebooktype',
                    {
                        ...
                        data: { pageTitle: 'نوع دفترچه تلفن' },
                        ncyBreadcrumb: {
                ...
                .state('index.discountoffer',
                    {
                        ...
                        data: { pageTitle: 'پیشنهادات تخفیف' },
                        ncyBreadcrumb: {
                ...
                .state('index.campaigndetailitem',
                    {
                        ...
                        data: { pageTitle: 'موارد موردنیاز برای کمپ' },
                        ncyBreadcrumb: {
                ...
                .state('index.linkmanagementtarget',
                    {
                        ...
                        params: { MemberId: null, BillBoardPatternId: null },
                        controller: "linkManagementTargetController",
                        controllerAs: "linkManagementTarget",
                        data: { pageTitle: 'محتوا تبادل لینک' },
                        ncyBreadcrumb: {
                ...
                .state('index.linkmanagementcomment',
                    {
                        ...
                        data: { pageTitle: 'کامنت تبادل لینک' },
                        ncyBreadcrumb: {
                ...
                .state('index.linkmanagementaccounting',
                    {
                        ...
                        data: { pageTitle: 'محاسبه تبادل لینک' },
                        ncyBreadcrumb: {
                ...
                .state('index.linkmanagementaccountingdetail',
                    {
                        ...
                        data: { pageTitle: 'جزییات محاسبه تبادل لینک' },
                        ncyBreadcrumb: {
                ...
                .state('index.linkmanagementcontentcategoryfavorite',
                    {
                        ...
                        data: { pageTitle: 'علاقه مندیها تبادل لینک' },
                        ncyBreadcrumb: {
                ...
                .state('index.linkmanagementcontentcategoryotherinfo',
                    {
                        ...
                        data: { pageTitle: 'توضیحات تبادل لینک' },
                        ncyBreadcrumb: {
                ...
                .state('index.linkmanagementcategorysimilar',
                    {
                        ...
                        data: { pageTitle: 'دسته بندی مرتبط تبادل لینک' },
                        ncyBreadcrumb: {
                ...
                .state('index.linkmanagementcontentsimilar',
                    {
                        ...
                        data: { pageTitle: 'لیست مرتبط تبادل لینک' },
                        ncyBreadcrumb: {
                ...
                .state('index.newsshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'اخبار - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.newssharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'اخبار - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.quoteshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'سخن روز - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.quotesharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'سخن روز - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.shopshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'فروشگاه - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.shopsharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'فروشگاه - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.chartshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'چارت - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.chartsharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'چارت - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.imagegalleryshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'تصویر - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.imagegallerysharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'تصویر - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.moviegalleryshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'فیلم - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.moviegallerysharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'فیلم - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.musicgalleryshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'موسیقی - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.musicgallerysharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'موسیقی - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.serviceshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'خدمات - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.servicesharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'خدمات - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.productshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'محصولات - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.productsharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'محصولات - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.blogshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'دست نوشته ها - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.blogsharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'دست نوشته ها - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.articleshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'مقالات - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.articlesharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'مقالات - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.biographyshareservercategory',
                    {
                        ...
                        data: { pageTitle: 'زندگینامه - اشتراک گذاری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.biographysharerecivercategory',
                    {
                        ...
                        data: { pageTitle: 'زندگینامه - اشتراک گیری' },
                        ncyBreadcrumb: {
                            label: 'مینور'
                        },
                        resolve: {
                ...
                .state('index.cmsmodulesaleitem',
                    {
                        ...
                        data: { pageTitle: 'cmsModuleSaleItem' },
                        ncyBreadcrumb: {
                ...
                .state('index.cmsmodulesaleserial',
                    {
                        ...
                        data: { pageTitle: 'CmsModuleSaleSerial' },
                        ncyBreadcrumb: {
                ...
                .state('index.cmsmodulesaleinvoice',
                    {
                        ...
                        data: { pageTitle: 'CmsModuleSaleInvoice' },
                        ncyBreadcrumb: {
                ...
                .state('index.modulesrelationship',
                    {
                        ...
                        data: { pageTitle: 'ModulesRelationship' },
                        ncyBreadcrumb: {
