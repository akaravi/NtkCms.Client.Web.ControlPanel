...
//#help/ سلکتور دسته بندی در ویرایش محتوا
 mvGalleryTag.LinkCategoryTagIdSelector = {
    ...
    mvGalleryTag.replaceFile = function (name) {
        ...
        // Delete the file
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", mvGalleryTag.fileIdToDelete, 'GET').success(function (response1) {
    ...
    mvGalleryTag.saveNewFile = function () {
        ajax.call(mainPathApi+"CmsFileContent/add", mvGalleryTag.FileItem, 'POST').success(function (response) {
            if (response.IsSuccess) {
    ...
    mvGalleryTag.onSelection = function (node, selected) {
        ...
        mvGalleryTag.selectedItem.previewImageSrc = "CmsFiles/img/loader.gif";
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", node.Id, "GET").success(function (response) {
            mvGalleryTag.selectedItem.previewImageSrc = "/files/" + response.Item.Id + "/" + response.Item.FileName;
        }).error(function (data, errCode, c, d) {
            console.log(data);
        });
    }
