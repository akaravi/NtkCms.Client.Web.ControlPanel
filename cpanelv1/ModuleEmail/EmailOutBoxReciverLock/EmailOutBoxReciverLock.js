...
*/
   ...
   /* emailOutBoxReciverLock.deleteRow = function () {
    ...
    emailOutBoxReciverLock.exportFile = function () {
        ...
        ajax.call(mainPathApi+'cmssite/exportfile', emailOutBoxReciverLock.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            emailOutBoxReciverLock.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    emailOutBoxReciverLock.onSelection = function (node, selected) {
        ...
        emailOutBoxReciverLock.selectedItem.previewImageSrc = "CmsFiles/img/loader.gif";
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", node.Id, "GET").success(function (response) {
            emailOutBoxReciverLock.selectedItem.previewImageSrc = "/files/" + response.Item.Id + "/" + response.Item.FileName;
        }).error(function (data, errCode, c, d) {
            console.log(data);
        });
    }
