...
emailPrivateSiteConfig.removeFromCollection = function(listsimilar,idSuperSeder) {
    ...
    emailPrivateSiteConfig.exportFile = function() {
        ...
        ajax.call(mainPathApi+'cmssite/exportfile', emailPrivateSiteConfig.gridOptions.advancedSearchData.engine, 'POST').success(function(response) {
            emailPrivateSiteConfig.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    emailPrivateSiteConfig.getCount = function() {
        ajax.call(mainPathApi+"cmssite/count", emailPrivateSiteConfig.gridOptions.advancedSearchData.engine, 'POST').success(function(response) {
            emailPrivateSiteConfig.addRequested = false;
            rashaErManage.checkAction(response);
