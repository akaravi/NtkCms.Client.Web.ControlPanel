app.controller("jobPropertyController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $window, $filter) {
    ...
    jobProperty.editRow = function (frm) {
        ...
        if (jobProperty.oldLinkPropertyTypeId != jobProperty.selectedItem.LinkPropertyTypeId) {
            ...
            ajax.call(mainPathApi+'JobPropertyDetailValue/deleteBatch', engine, 'DELETE').success(function (response) {
                rashaErManage.checkAction(response);
    ...
    //jobProperty.isloadind = true;
    //jobProperty.isNeighloadind = true;

    //jobProperty.onProvinceChange = function (provinceId) {
    //    jobProperty.cityCmsLocatinoListItems = [];//Clear previous cities
    //    jobProperty.neighbourhoodCmsLocatinoListItems = [];//Clear previous neighbourhoods
    //    var engine = {
    //    };
    //    var cityfilterModel = {
    ...
    //        jobProperty.isloadind = false;
    //        rashaErManage.checkAction(response);
    //        jobProperty.cityCmsLocatinoListItems = response.ListItems;
    //    }).error(function (data, errCode, c, d) {
    //        jobProperty.busyIndicator.isActive = false;
    //        rashaErManage.checkAction(data, errCode);
    //    });
    ...
    //jobProperty.onCitiesChange = function (cityId) {
    //    var engine = {
    //    };
    ...
    //        jobProperty.isNeighloadind = false;
    //        rashaErManage.checkAction(response);
    //        jobProperty.neighbourhoodCmsLocatinoListItems = response.ListItems;
    //    }).error(function (data, errCode, c, d) {
    //        jobProperty.busyIndicator.isActive = false;
    //        rashaErManage.checkAction(data, errCode);
    //    });
    ...
    jobProperty.replaceFile = function (name) {
        ...
        // Delete the file
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", jobProperty.fileIdToDelete, 'GET').success(function (response1) {
    ...
    jobProperty.saveNewFile = function () {
        ajax.call(mainPathApi+"CmsFileContent/add", jobProperty.FileItem, 'POST').success(function (response) {
            if (response.IsSuccess) {
