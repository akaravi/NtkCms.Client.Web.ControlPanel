...
objectProperty.selectedItemLinkobjectUserId=false;
 ...
 objectProperty.GeolocationConfig={
        ...
        locationobjectString:'GeolocationString',
...
*/
    ...
    objectProperty.editRow = function (frm) {
        ...
        if (objectProperty.oldLinkPropertyTypeId != objectProperty.selectedItem.LinkPropertyTypeId) {
            ...
            ajax.call(mainPathApi+'objectPropertyDetailValue/deleteBatch', engine, 'DELETE').success(function (response) {
                rashaErManage.checkAction(response);
...
function stringfyLinkFileIds(arrayOfFiles) {
 ...
 // Filter Texts for CmsUser
    ...
    objectProperty.replaceFile = function (name) {
        ...
        // Delete the file
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", objectProperty.fileIdToDelete, 'GET').success(function (response1) {
    ...
    objectProperty.saveNewFile = function () {
        ajax.call(mainPathApi+"CmsFileContent/add", objectProperty.FileItem, 'POST').success(function (response) {
            if (response.IsSuccess) {
