   ...
   shopProcess.filePickerMainImage = {
    ...
    shopProcess.init = function () {
        ajax.call(mainPathApi+"shopProcess/getAllInputValueMethod", {}, 'POST').success(function (response) {
            shopProcess.InputValueMethod = response;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    shopProcess.onSelection = function (node, selected) {
        ...
        shopProcess.selectedItem.previewImageSrc = "CmsFiles/img/loader.gif";
        ajax.call(mainPathApi+"CmsFileContent/getviewmodel", node.Id, "GET").success(function (response) {
            shopProcess.selectedItem.previewImageSrc = "/files/" + response.Item.Id + "/" + response.Item.FileName;
        }).error(function (data, errCode, c, d) {
            console.log(data);
        });
    }
      ...
      if ($("#save-icon" + index).hasClass("fa-save")) {
          ...
          ajax
            ...
            .success(function(response) {
              ...
              var result = 0;
              ajax
                .call(mainPathApi + "CmsFileContent/add", shopProcess.FileItem, "POST")
                .success(function(response) {
                  if (response.IsSuccess) {
                    shopProcess.FileItem = response.Item;
                    shopProcess.showSuccessIcon();
