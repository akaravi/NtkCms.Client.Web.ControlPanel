...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // On Module Change Event
   ...
   /* shopProcess.LoadUniversalMenuProcessOfModuleProcessCustomize = function (moduleProcessId) {
    ...
    //shopProcess.onPaymentProcessCustomizeChange = function (InputFormSiteAdminClassJsonForm) {
    //    // Get selected Layout to load form using JsonFormFormat in ViewModel
    //    shopProcess.defaultValue = [];
    //    shopProcess.addRequested = true;
    //    shopProcess.busyIndicator.isActive = true;
    //    var model = { Filters: [] };
    //    model.Filters.push({ PropertyName: "Id", SearchType: 0, IntValue1: parseInt(paymentProcessId) });
    //    ajax.call(mainPathApi+'cmsModulePaymentProcess/GetOne', model, "POST").success(function (response3) {

    //        rashaErManage.checkAction(response3);
    //        shopProcess.paymentProcessListItems = response3.ListItems;
    //        var customizeValue = response3.Item.ProcessInputFormSiteAdminClassJsonFormFormatter;
    //        shopProcess.selectedItem.LinkModuleId = response3.Item.LinkModuleId;
    //        //shopProcess.selectedItem.ExternalPaymentProcessInputFormSiteAdminClassJsonFormValues = response3.Item.ExternalPaymentProcessInputFormSiteAdminClassJsonFormValues;


    //        // Get selected Layout to load form using JsonFormFormat in ViewModel
    //        //var model = { Filters: [] };
    //        //model.Filters.push({ PropertyName: "Id", SearchType: 0, IntValue1: parseInt(shopProcess.selectedItem.LinkExternalPaymentProcessCustomizeId) });
    //        ajax.call(mainPathApi+'CmsModulePaymentProcessCustomize/GetOne', {}, 'POST').success(function (response2) {
